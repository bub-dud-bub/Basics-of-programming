...
def pingpong(n):
    ...
    # if n != 0:
    #     pingpong(n-1)
    # if (n // 10 == abs(8) or n % 10 == abs(8)) and n > 1:
    #     return 1 - pingpong(-n+1)
    # elif (n // 10 == abs(8) or n % 10 == abs(8)) and n < -1:
    #     return 1 + pingpong(-n-1)
    # elif n > 1:
    #     return 1 + pingpong(n-1)
    # elif n < -1:
    ...
    if (n // 10 == 8 or n % 10 == 8 or n % 8 == 0) and n > 1:
        return 1 + pingpong(-n+1)
    elif (n // -10 == 8 or n % -10 == -8 or n % -8 == 0) and n < -1:
...
def count_coins(total):
    ...
    if (total == 0):
        ...
        return 0
    if (total % 25 == 0):
        return total // 5 - 1 + count_coins(total-10) + count_coins(total-25)
    return total // 5 + 1 + count_coins(total-10)
    # if (total >= 25):
    #     return count_coins(total - 25) + count_coins(total - 10) + count_coins(total - 5)
    # elif (total >= 10):
    #     return count_coins(total - 10) + count_coins(total - 5)
    # elif (total == 5):
    #     return count_coins(total - 5) + count_coins(total - 1)
    # elif (total >= 1):
    #     return 0 + count_coins(total - 1)
    # else:
    #     return 1
...
def make_anonymous_factorial():
    ...
    True
    """
    return (lambda a: lambda b: a(a, b))(lambda a, b: b if b == 1 else mul(b, a(a, sub(b, 1))))
